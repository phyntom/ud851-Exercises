...
public class ChildActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent startedChildActivity = getIntent();
        // TODO (4) Create an if statement to check if this Intent has the extra we passed from MainActivity
        if(startedChildActivity.hasExtra(Intent.EXTRA_TEXT)){
            String enteredText=startedChildActivity.getStringExtra(Intent.EXTRA_TEXT);
