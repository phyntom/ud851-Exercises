...
public class NotificationUtils {
    ...
    private static final int ACTION_DRINK_PENDING_INTENT_ID = 3456;
    ...
    public static NotificationCompat.Action drinkWaterAction(Context context) {
        ...
        PendingIntent incrementWaterCountPendingIntent = PendingIntent.getService(context, ACTION_DRINK_PENDING_INTENT_ID, incrementWaterCount, PendingIntent.FLAG_UPDATE_CURRENT);
        NotificationCompat.Action drinkWaterAction = new NotificationCompat.Action(R.drawable.ic_local_drink_grey_120px, "I did it", incrementWaterCountPendingIntent);
