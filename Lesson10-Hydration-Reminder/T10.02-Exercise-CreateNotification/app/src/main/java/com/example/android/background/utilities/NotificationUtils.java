...
public class NotificationUtils {
    ...
    public static final int WATER_REMINDER_PENDING_INTENT = 3128;

    private static final int WATER_REMINDER_NOTIFICATION_ID= 2239;

    public static final String WATER_REMINDER_NOTIFICATION_CHANNEL_ID = "1234";
    ...
    private static PendingIntent contentIntent(Context context) {
        ...
        return PendingIntent.getActivity(context, WATER_REMINDER_PENDING_INTENT, startActivity, PendingIntent.FLAG_UPDATE_CURRENT);
    }
